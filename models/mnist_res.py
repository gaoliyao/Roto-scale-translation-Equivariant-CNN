...
def mnist_res_scalar_28_rot_1(**kwargs):
    num_scales = 4
    factor = 3.0
    min_scale = 1.7
    mult = 1.5
...
def mnist_res_scalar_28_rot_8(**kwargs):
    num_scales = 4
    factor = 3.0
    min_scale = 1.7
    mult = 1.5
...
def mnist_res_scalar_56_rot_1(**kwargs):
    num_scales = 4
    factor = 3.0
    min_scale = 1.7
    mult = 1.5
...
def mnist_res_scalar_56_rot_4(**kwargs):
    num_scales = 4
    factor = 3.0
    min_scale = 1.7
    mult = 1.5
...
def mnist_res_scalar_56_rot_8(**kwargs):
    num_scales = 4
    factor = 3.0
    min_scale = 1.7
    mult = 1.5
...
def mnist_res_vector_56_rot_8_interrot_1(**kwargs):
    num_scales = 4
    factor = 3.0
    min_scale = 1.7
    mult = 1.5
...
def mnist_res_vector_56_rot_8_interrot_4(**kwargs):
    num_scales = 4
    factor = 3.0
    min_scale = 1.7
    mult = 1.5
...
def mnist_res_vector_56_rot_8_interrot_8(**kwargs):
    num_scales = 4
    factor = 3.0
    min_scale = 1.7
    mult = 1.5
...
def mnist_ses_scalar_28p(**kwargs):
    ...
    model = MNIST_SES_Scalar(pool_size=4, kernel_size=size, scales=scales,
                             basis_type='F', mult=mult, max_order=4, dropout=dropout)
    return model
